...
return [
    ...
    'events' => [
        ...
        */
        ...
        /*
        |--------------------------------------------------------------
        | زوبوكسي — تحديثات توصيل مرسول (المندوب)
        |--------------------------------------------------------------
        | المُطلِق: App\Services\Mrsool\MrsoolDeliveryService (تغيّر مرحلة
        | التوصيل: تعيين مندوب / في الطريق / تم التوصيل / تعذّر). Push فقط
        | افتراضياً — تنبيه تشغيلي لحظي لمدير الفرع.
        */
        'mrsool_delivery_update' => [
            'label'            => 'تحديث توصيل مرسول',
            'label_en'         => 'Mrsool delivery update',
            'group'            => 'زوبوكسي',
            'default_channels' => ['email' => false, 'push' => true],
            'audience_roles'   => ['Branch Manager', 'Super Admin'],
            'user_configurable' => true,
