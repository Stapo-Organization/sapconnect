...
class Zooboxi_V2_Bootstrap
{
    ...
    public static function register_routes(): void
    {
        ...
        // `/push/*` — the device registry. Registered whenever the class is
        // present; a store with no FCM credentials simply answers with the
        // defaults and sends nothing.
        if (class_exists('Zooboxi_V2_Push_Controller')) {
            Zooboxi_Push::maybe_install();
            (new Zooboxi_V2_Push_Controller())->register_routes();
        }
