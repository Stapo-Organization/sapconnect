...
/// SAR amount, rounded, grouped: e.g. "12٬450 ر.س".
String sarAmount(num v) => '${_grouped(v.round())} ر.س';

/// Compact SAR for tight chips: 12.4 ألف / 1.2 مليون.
String sarCompact(num v) {
  final a = v.abs();
  if (a >= 1000000) return '${(v / 1000000).toStringAsFixed(1)} مليون ر.س';
  if (a >= 1000) return '${(v / 1000).toStringAsFixed(1)} ألف ر.س';
  return sarAmount(v);
}
